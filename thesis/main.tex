...
\include{ThesisSpecificPages/cover_page}
% \cleardoublepage
% \include{ThesisSpecificPages/copyright}
%\cleardoublepage
\include{ThesisSpecificPages/inner_cover_page}
%\cleardoublepage
\pagenumbering{roman}
...
%\doublespacing 
%\include{ThesisSpecificPages/certificate}
\cleardoublepage

\pagestyle{plain}

%\doublespacing 
%\include{ThesisSpecificPages/acknowledge}
...
\input{Ch2-AnalyticalFw/Chapter2.tex}
%\input{Ch3-OverallFlow/main.tex}
%\input{Ch4-DSE/main.tex}
%\input{Ch5-GraphicalModel/main.tex}
%\input{Ch6-RuntimeCtrl/main.tex}
%\input{Ch7-CaseStudies/main.tex}
%\input{Ch8-Conclusion/main.tex}
%\input{appendix}
...
\input{ThesisSpecificPages/publication}
\cleardoublepage
%\onehalfspacing

%\doublespacing 
\input{ThesisSpecificPages/bio}
\cleardoublepage
%\onehalfspacing
\pagestyle{plain}
