...
\figurename{~\ref{fig:blockPartialSum}} further illustrates the partitions $P$ used in computing $\sum_{m{=}0}^{r}S_{(r,m)}^{L}[k]$ and $\sum_{m{=}r{+}1}^{\ceil{\frac{N}{B}}{-}1}S_{(r,m)}^{U}[k]$.
